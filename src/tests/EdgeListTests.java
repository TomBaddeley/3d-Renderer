...
public class EdgeListTests {
    ...
    public void testNiceXInterpolation() {
        ...
        List<Polygon> pl = new ArrayList<>();
        pl.add(poly);

        HashMap<Vector3D,Vector3D> hm = Pipeline.buildVertexNormalMap(pl);
        EdgeList el = Pipeline.computeEdgeList(poly,hm);
